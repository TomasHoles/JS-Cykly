...
function drawObjekt(ctverec=10,gap=35){
    for(i =1;i<=ctverec;i++){
        drawRectangle(canvas.width/16, canvas.height/40,i*gap,i*gap,"red");
        drawRectangle(canvas.width/16, canvas.height/2,i*gap,i*gap,"blue");
        drawRectangle(canvas.width/2, canvas.height/40,i*gap,i*gap,"yellow");
        drawRectangle(canvas.width/2, canvas.height/2,i*gap,i*gap,"green");
    }
}
